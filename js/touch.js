...
define(["colors", "fullscreen", "audio", "sprites", "dir"], 
	...
	var Touch = function (canvas, pixelWindow, pixelSize) {
		...
		var spriteData = 
		"v1.0:";
		...
		//shoot up and down
		buttons.push({x:178, y:50, w:13, h:19, sprite:sprites[5],
			dx:178, dy:50, dw:13, dh:19, 
			key:KeyEvent.DOM_VK_DOWN});

		buttons.push({x:178, y:30, w:13, h:19, sprite:sprites[6],
			dx:178, dy:30, dw:13, dh:19, 
		...
		document.querySelector("#menu").addEventListener('touchstart', noBubble);
		document.querySelector("#menu").addEventListener('touchend', noBubble);
		document.querySelector("#menu").addEventListener('touchmove', noBubble);
	};
	return Touch;
});
